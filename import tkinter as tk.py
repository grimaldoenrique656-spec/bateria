...
def seleccionaTabla():
    print("has hecho click en un boton")
...
# LISTADO DINAMICO DE LAS TABLAS DE LA BASE DE DATOS
...
cursor.execute("SHOW tables IN universidad")
listadotablas = cursor.fetchall()
for tabla in listadotablas:
    tk.Button(tablas, text=tabla[0], command=seleccionaTabla).pack(padx=5, pady=5)
